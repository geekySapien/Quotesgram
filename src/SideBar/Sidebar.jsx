        ...
        <>
            <div className="flex flex-col mt-8 gap-3">
                <div className="flex flex-col gap-5 items-center">
                    <h1 className="text-2xl font-bold textStyle text-gray-700">About Me</h1>
                ...
                <div className="flex flex-col gap-5  ">
                    <h2 className="py-2 text-lg font-semibold text-gray-600 text-center border-t-2 border-b-2 border-gray-200">Categories</h2>
                    <ul className="listItems cursor-pointer" >
                        <li className="inline-block w-1/2 py-2">Programming</li>
                        <li className="inline-block w-1/2 py-2 ">Tech</li>
                        <li className="inline-block w-1/2 py-2">Life</li>
                        <li className="inline-block w-1/2 py-2">Finance</li>
                    </ul>
